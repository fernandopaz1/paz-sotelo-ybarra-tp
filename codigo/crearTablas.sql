...
create table rechazo (nroRechazo serial, nroTarjeta char[], nroComercio int, fecha date, monto float, motivo text);
...
create table alerta (nroAlerta serial, nroTarjeta char[], fecha date, nroRechazo int, codAlerta int, descripcion text);
